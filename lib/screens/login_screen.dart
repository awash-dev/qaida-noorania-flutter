...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _launchUrl() async {
    final uri = Uri.parse('http://rise-tech-solutions.com');
      ...
      body: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Stack(
          children: [
            ...
            // ── Dark tint ──
            Positioned.fill(
              child: Container(color: const Color(0xCC050E0A)),
            ),
            // ── Top gradient ──
            Positioned(
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF0a1912), Color(0xEE0a1912), Colors.transparent],
                  ),
                ),
              ),
            ),
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.transparent, Color(0xF50a1912), Color(0xFF0a1912)],
                  ),
                ),
              ),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Footer — developed by Rise Tech ──
          GestureDetector(
            onTap: _launchUrl,
            child: RichText(
              text: const TextSpan(
                style: TextStyle(color: Color(0x80C5A880), fontSize: 12),
                children: [
